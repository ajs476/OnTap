...
public class SoftDrinkMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<drinkObject> softDrinkMenu = HomeActivity.softDrinkMenu;
        ...
        increaseQtyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //int newQty = qty;
                int originPrice = softDrinkMenu.get(itemPosition).getDrinkPrice();
        ...
        decreaseQtyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(qty>1){
                    ...
                    Toast.makeText(SoftDrinkMenuActivity.this, "Cannot decrease amount from 1", Toast.LENGTH_SHORT).show();
                }
        ...
        addDrinkButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SoftDrinkMenuActivity.this, "Added to order", Toast.LENGTH_SHORT).show();
                List<drinkObject> myTabOrder = HomeActivity.myTabOrder;
                drinkObject newDrink = new drinkObject(drinkNameText.getText().toString(),"Y","Beer",softDrinkMenu.get(itemPosition).getDrinkPrice());
                newDrink.setDrinkQuantity(qty);
                myTabOrder.add(newDrink);
                Intent myIntent = new Intent(SoftDrinkMenuActivity.this, MyTabActivity.class);
        ...
        mySoftDrinkList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (!(itemPosition > softDrinkMenu.size() - 1)) {
                    // ListView Clicked item value
                    //String itemValue = (String) myBeerList.getItemAtPosition(position);
                    //newQty = Integer.parseInt(drinkQtyText.getText().toString());
                    int originPrice = softDrinkMenu.get(position).getDrinkPrice();
                    newPrice = originPrice * qty;
                    //drinkQtyText.setText("1");
                    totalCostText.setText("$" + Integer.toString(newPrice));
                    drinkNameText.setText(softDrinkMenu.get(position).getDrinkName());
